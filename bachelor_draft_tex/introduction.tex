...
\newline
Furthermore, the closer the small satellite are to earth, the sooner they will burn to ashes caused by entering earth's atmosphere. This helps keeping the orbits clean, as space debris can cause collateral damage to future space missions \cite{akahoshi_influence_2008}.
\newline
However, the small distance a satellite has in \ac{LEO} leads to a severe problem to retrieve data, as data transmission is only possible when the CubeSat is visible to the \ac{GCC}, leading to communication timeframes as short as 30 minutes. This fact, combined with the slow data rate
