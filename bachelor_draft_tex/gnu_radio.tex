...
\caption[Editing a flowgraph in \acl{GRC} - licensed under the \acl{GNU GPL} \cite{gnu_radio_companion}]{Editing a flowgraph in \acl{GRC} - licensed under the \acl{GNU GPL} \label{GRCFlowgraph}}
\end{figure}
\newline
